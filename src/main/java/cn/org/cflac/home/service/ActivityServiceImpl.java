...
public class ActivityServiceImpl implements ActivityService {
	...
	@Override
	public Paging<Activity> findActivityList(String search, String activityName, String logdate, String starttime,
			String endtime, Integer start, Integer length, Integer draw) {
	...
	/*
	 * @Override public String findActivityListByVideoTag(String tagName) {
	 * 
	...
	public Paging<Activity> findActivityList2(String tagName, Integer start, Integer length, Integer draw) {
		...
		/*
		 * map1.put("logdate", logdate); map1.put("starttime", starttime);
		 * map1.put("endtime", endtime);
		 *///
