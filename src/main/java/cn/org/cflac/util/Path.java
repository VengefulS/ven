...
public class Path {
	...
	public static final String PIC_UPLOAD_PATH = "http://localhost:9000/resource"; 
	
	
	// /opt/lar/files/videomanager/videoresource
	//F:/opt/lar/files/videomanager/videoresource
	public static final String UPLOAD_PATH = "F:/opt/lar/files/videomanager/videoresource"; 
	...
	public static final String TEMP_PATH = "F:/opt/lar/files/videomanager";
}
